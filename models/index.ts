export interface CharacterDataWrapper {
  ...
  attributionText: string; // The attribution notice for this result. Please display either
                           // this notice or the contents of the attributionHTML field on all
...
export interface StoryList {
  ...
  collectionURI: number; // The path to the full list of stories in this collection.
...
export interface EventSummary {
  resourceURI: number; // The path to the individual event resource.
